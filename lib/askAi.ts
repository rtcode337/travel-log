 ...
 * 開くURLを組み立てる。スポット詳細のGeminiのボタンで使う。
 *
 * **聞く相手はGeminiだけにしてある。** かつては押してから相手(Claude・ChatGPT・
 * Perplexity・Grok)を選ぶボタンを別に並べていたが、渡し方も送信されるかどうかも
 * サービスごとに違ううえ予告なく変わり、確かめ直す手間に見合わなかった。
 *
