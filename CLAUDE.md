...
**カテゴリだけ折り返しを許す**(`ChoiceRow`の`wrap`)—— 値が長く数も多い種別
(飲食店の12個など)があり、1行に詰めると1つあたりの幅が足りずに文字が潰れるため。
